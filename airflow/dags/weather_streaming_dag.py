...
with DAG(
    ...
    submit_job = BashOperator(
        ...
        bash_command='${AIRFLOW_HOME}/scripts/spark/bin/spark-submit ${AIRFLOW_HOME}/scripts/weather_streaming.py kafka-1:9092  weather_data weather_data_avg {{ execution_date }}')
