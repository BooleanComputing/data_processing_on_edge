...
with DAG(
    ...
    submit_job = BashOperator(
        ...
        bash_command='${AIRFLOW_HOME}/spark/bin/spark-submit --jars /usr/local/airflow/scripts/spark_jars/commons-pool2-2.11.1.jar,/usr/local/airflow/scripts/spark_jars/spark-sql-kafka-0-10_2.12-3.4.0.jar,'
